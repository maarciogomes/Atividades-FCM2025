...
library(readxl) #Manipulação e transformação de dados [Essencial para filtrar linhas, selecionar colunas, etc.]
library(dplyr) #Organização e arrumação de dados ("Tidy Data") [Usado para reestruturar dados, entre os formatos longo e #amplo]
library(tidyr)
library(geobr)
library(sf)
library(ggplot2)
